...
class ourEditField :	public editLabel {

	public:
				ourEditField(int x,int y,int w,int h,char* inMsg,int textSize,char* outMsg);
	virtual	~ourEditField(void);
...
class qGame : public  cellOSPanel {
	...
	virtual	void  loop();
				...
				ourEditField*	theEditField;			// The text edit field.
				colorRect*		theEditBase;			// Background of text edit window.
				bmpKeyboard*	ourKeyboard;			// Just like it sounds, our texting keyboard.
