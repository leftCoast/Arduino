...
#define PULSE_OFFSET 240        // In the end, it seems like everything takes too long. By this much.
...
void readValues(void) {
  ...
  channels[ELEVAOTOR] = round(pitchMapper.Map(analogRead(PITCH_PIN)));
  ...
  Serial.print("AILERON   : ");Serial.println(channels[AILERON]);
  Serial.print("ELEVAOTOR : ");Serial.println(channels[ELEVAOTOR]);
  Serial.print("RUDDER    : ");Serial.println(channels[RUDDER]);
  Serial.print("AUX       : ");Serial.println(channels[AUX]);
  Serial.println();
}
