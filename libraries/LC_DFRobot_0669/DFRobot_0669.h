...
class maskableILI9488 :	public ILI9488_t3 {
								
	public :
				maskableILI9488(int cs, int rst);
	virtual	~maskableILI9488(void);
...
class DFRobot_0669 : public displayObj {

	public :
				DFRobot_0669(byte inCS,byte inRst);
	virtual	~DFRobot_0669(void);
