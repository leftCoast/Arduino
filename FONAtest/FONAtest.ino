  ...
  switch (command) {
    ...
    case 'L': {
        ...
        if (type == FONA808_V1) {
          ...
          Serial.print(F("utctime(yyyymmddHHMMSS),ttff,satellites,speed,course"));
        } else {
          Serial.print(F("Reply in format: mode,fixstatus,utctime(yyyymmddHHMMSS),"));
          Serial.print(F("latitude,longitude,altitude,speed,course,fixmode,reserved1,HDOP,PDOP,VDOP,"));
          Serial.print(F("reserved2,view_satellites,used_satellites,reserved3,C/N0max,HPA,VPA"));
        }
